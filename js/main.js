...
window.TA = (function(){
  const ARTICLES = [
    {
      href: 'artigos/os-10-melhores-smartphones-de-2026.html', category: 'Smartphones', icon: 'phone',
    ...
    {
      href: 'artigos/7-melhores-notebooks-2026.html', category: 'Notebooks', icon: 'laptop',
    ...
    {
      href: 'artigos/5-fones-bluetooth-custo-beneficio.html', category: 'Áudio', icon: 'headphones',
    ...
    {
      href: 'artigos/casa-inteligente-por-500.html', category: 'Casa inteligente', icon: 'home',
    ...
    {
      href: 'artigos/xiaomi-17t-review.html', category: 'Smartphones', icon: 'phone',
    ...
    if (!pageItems.length){
      ...
      grid.innerHTML = pageItems.map(a => `
        <a href="${a.href}" class="article-card">
          ...
          <div class="article-thumb"><svg width="40" height="40" viewBox="0 0 24 24" fill="none">${ICONS[a.icon] || ICONS.phone}</svg></div>
