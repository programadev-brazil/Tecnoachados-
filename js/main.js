...
window.TA = (function(){
  const ARTICLES = [
    ...
    },
    {
      ...
      date: '28 ago 2026', dateSort: 20260828, readtime: '9 min de leitura', isNew: true
    },
    {
    ...
    {
      href: 'artigos/gta6-trailer-netflix-2026.html', category: 'Games', icon: 'game', cover: 'images/gta6/cover-vice-city-noturna.jpg',
      title: 'GTA 6 e Netflix: a parceria inédita por trás do maior lançamento do ano',
      excerpt: 'Rockstar liberou 26 minutos de gameplay em primeira mão na Netflix, após uma semana de vazamentos. Data, preço e o que a imprensa está achando.',
      date: '27 ago 2026', dateSort: 20260827, readtime: '11 min de leitura', isNew: true
    },
    {
      href: 'artigos/ia-2026-guia-completo.html', category: 'Notícias', icon: 'news', cover: 'images/ia2026/cover-vr.jpg',
      title: 'Inteligência Artificial em 2026: como ela já está no seu bolso',
      excerpt: 'Guia completo sobre onde a IA já está presente no seu dia a dia, IA local x nuvem, agentes de IA, os riscos envolvidos e o que vem a seguir.',
      date: '31 ago 2026', dateSort: 20260831, readtime: '15 min de leitura', isNew: true
    },
    {
      href: 'artigos/ps6-lancamento-preco-2026.html', category: 'Games', icon: 'game', cover: 'images/ps6/cover-vr-ps6.jpg',
      title: 'PS6: quando será lançado, quanto pode custar e como pode mudar o mercado de games',
      excerpt: 'A Sony ainda não confirmou data nem preço do PS6. Veja o que já se sabe sobre hardware, retrocompatibilidade e o impacto da próxima geração PlayStation.',
      date: '19 set 2026', dateSort: 20260919, readtime: '9 min de leitura', isNew: true
    }
  ];
  ...
  const ICONS = {
    ...
    game: '<rect x="2" y="7" width="20" height="10" rx="5" stroke="currentColor" stroke-width="1.6"/><path d="M7 10v4M5 12h4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="16" cy="10.5" r="1" fill="currentColor"/><circle cx="18.5" cy="13" r="1" fill="currentColor"/>'
  };
  ...
  return {
    ...
    goHome(){ state.category = 'Todos'; state.mode = 'todos'; state.page = 1; render(); }
  };
})();
